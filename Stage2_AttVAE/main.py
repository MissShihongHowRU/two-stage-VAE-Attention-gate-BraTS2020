...
config["result_path"] = os.path.join(config["base_path"], "model", save_folder)   # save models and status files
config["saved_model_file"] = config["result_path"] + pth_name
# config["segmentation_map_path"] = config["base_path"] + "/pred/" + segmentation_map_path + "/"
config["segmentation_map_path"] = "../pred/" + segmentation_map_path + "/"
